...
package Allegro5.Allegro.Audio is
   ...
   function al_create_sample
     (buf : System.Address;
      ...
      free_buf : Extensions.bool) return System.Address;
   ...
   procedure al_destroy_sample (spl : System.Address);
   ...
   function al_create_sample_instance (data : System.Address) return System.Address;
   ...
   procedure al_destroy_sample_instance (spl : System.Address);
   pragma Import (C, al_destroy_sample_instance, "al_destroy_sample_instance");

   -- Return the frequency of the sample.
   function al_get_sample_frequency (spl : System.Address) return unsigned;
   pragma Import (C, al_get_sample_frequency, "al_get_sample_frequency");

   -- Return the length of the sample in sample values.
   function al_get_sample_length (spl : System.Address) return unsigned;
   pragma Import (C, al_get_sample_length, "al_get_sample_length");

   -- Return the audio depth.
   function al_get_sample_depth (spl : System.Address) return ALLEGRO_AUDIO_DEPTH;
   pragma Import (C, al_get_sample_depth, "al_get_sample_depth");

   -- Return the channel configuration.
   function al_get_sample_channels (spl : System.Address) return ALLEGRO_CHANNEL_CONF;
   pragma Import (C, al_get_sample_channels, "al_get_sample_channels");

   -- Return a pointer to the raw sample data.
   function al_get_sample_data (spl : System.Address) return System.Address;
   pragma Import (C, al_get_sample_data, "al_get_sample_data");

   -- Return the frequency of the sample instance.
   function al_get_sample_instance_frequency (spl : System.Address) return unsigned;
   ...
   function al_get_sample_instance_length (spl : System.Address) return unsigned;
   ...
   function al_get_sample_instance_time (spl : System.Address) return float;
   pragma Import (C, al_get_sample_instance_time, "al_get_sample_instance_time");

   -- Return the audio depth.
   function al_get_sample_instance_depth (spl : System.Address) return ALLEGRO_AUDIO_DEPTH;
   pragma Import (C, al_get_sample_instance_depth, "al_get_sample_instance_depth");

   -- Return the channel configuration.
   function al_get_sample_instance_channels (spl : System.Address) return ALLEGRO_CHANNEL_CONF;
   pragma Import (C, al_get_sample_instance_channels, "al_get_sample_instance_channels");

   -- Return the playback mode.
   function al_get_sample_instance_playmode (spl : System.Address) return ALLEGRO_PLAYMODE;
   ...
   function al_get_sample_instance_playing (spl : System.Address) return Extensions.bool;
   pragma Import (C, al_get_sample_instance_playing, "al_get_sample_instance_playing");

   -- Return whether the sample instance is attached to something.
   function al_get_sample_instance_attached (spl : System.Address) return Extensions.bool;
   pragma Import (C, al_get_sample_instance_attached, "al_get_sample_instance_attached");

   -- Get the playback position of a sample instance.
   function al_set_sample_instance_position (spl : System.Address; val : unsigned) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_position, "al_set_sample_instance_position");

   -- Set the length of the sample instance in sample values.
   --
   -- Return true on success, false on failure. Will fail if the sample instance is currently playing.
   function al_set_sample_instance_length (spl : System.Address; val : unsigned) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_length, "al_set_sample_instance_length");
   ...
   function al_set_sample_instance_speed (spl : System.Address; val : float) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_speed, "al_set_sample_instance_speed");
   ...
   function al_set_sample_instance_gain (spl : System.Address; val : float) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_gain, "al_set_sample_instance_gain");
   ...
   --
   -- Returns true on success, false on failure. Will fail if the sample instance is attached directly to a voice.
   function al_set_sample_instance_pan (spl : System.Address; val : float) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_pan, "al_set_sample_instance_pan");

   -- Set the playback mode.
   --
   -- Returns true on success, false on failure.
   function al_set_sample_instance_playmode (spl : System.Address; val : ALLEGRO_PLAYMODE) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_playmode, "al_set_sample_instance_playmode");

   -- Change whether the sample instance is playing.
   --
   -- Returns true on success, false on failure.
   function al_set_sample_instance_playing (spl : System.Address; val : Extensions.bool) return Extensions.bool;
   pragma Import (C, al_set_sample_instance_playing, "al_set_sample_instance_playing");

   -- Detach the sample instance from whatever it's attached to, if anything.
   --
   -- Returns true on success.
   function al_detach_sample_instance (spl : System.Address) return Extensions.bool;
   ...
   function al_set_sample (spl : System.Address; data : System.Address) return Extensions.bool;
   ...
   function al_get_sample (spl : System.Address) return System.Address;
   pragma Import (C, al_get_sample, "al_get_sample");

   -- Play an instance of a sample data. Returns true on success, false on failure.
   function al_play_sample_instance (spl : System.Address) return Extensions.bool;
   pragma Import (C, al_play_sample_instance, "al_play_sample_instance");

   -- Stop an sample instance playing.
   function al_stop_sample_instance (spl : System.Address) return Extensions.bool;
   ...
   function al_create_audio_stream
     (buffer_count : stdint.size_t;
      ...
      freq : unsigned;
      depth : ALLEGRO_AUDIO_DEPTH;
      chan_conf : ALLEGRO_CHANNEL_CONF) return System.Address;
   ...
   procedure al_destroy_audio_stream (stream : System.Address);
   ...
   procedure al_drain_audio_stream (stream : System.Address);  -- AA5/addons/audio/allegro5/allegro_audio.h:230
   pragma Import (C, al_drain_audio_stream, "al_drain_audio_stream");

   -- Return the stream frequency.
   function al_get_audio_stream_frequency (stream : System.Address) return unsigned;
   pragma Import (C, al_get_audio_stream_frequency, "al_get_audio_stream_frequency");

   -- Return the stream length in samples.
   function al_get_audio_stream_length (stream : System.Address) return unsigned;
   ...
   function al_get_audio_stream_fragments (stream : System.Address) return unsigned;
   ...
   function al_get_available_audio_stream_fragments (stream : System.Address) return unsigned;
   pragma Import (C, al_get_available_audio_stream_fragments, "al_get_available_audio_stream_fragments");

   -- Return the relative playback speed.
   function al_get_audio_stream_speed (stream : System.Address) return float;
   pragma Import (C, al_get_audio_stream_speed, "al_get_audio_stream_speed");

   -- Return the playback gain.
   function al_get_audio_stream_gain (stream : System.Address) return float;
   pragma Import (C, al_get_audio_stream_gain, "al_get_audio_stream_gain");

   -- Get the pan value.
   function al_get_audio_stream_pan (stream : System.Address) return float;
   pragma Import (C, al_get_audio_stream_pan, "al_get_audio_stream_pan");

   -- Return the stream channel configuration.
   function al_get_audio_stream_channels (stream : System.Address) return ALLEGRO_CHANNEL_CONF;
   pragma Import (C, al_get_audio_stream_channels, "al_get_audio_stream_channels");

   -- Return the stream audio depth.
   function al_get_audio_stream_depth (stream : System.Address) return ALLEGRO_AUDIO_DEPTH;
   pragma Import (C, al_get_audio_stream_depth, "al_get_audio_stream_depth");

   -- Return the playback mode.
   function al_get_audio_stream_playmode (stream : System.Address) return ALLEGRO_PLAYMODE;
   pragma Import (C, al_get_audio_stream_playmode, "al_get_audio_stream_playmode");

   -- Return true if the stream is playing.
   function al_get_audio_stream_playing (spl : System.Address) return Extensions.bool;
   pragma Import (C, al_get_audio_stream_playing, "al_get_audio_stream_playing");

   -- Return whether the stream is attached to something.
   function al_get_audio_stream_attached (spl : System.Address) return Extensions.bool;
   pragma Import (C, al_get_audio_stream_attached, "al_get_audio_stream_attached");
   ...
   function al_get_audio_stream_fragment (stream : System.Address) return System.Address;
   pragma Import (C, al_get_audio_stream_fragment, "al_get_audio_stream_fragment");

   -- Set the relative playback speed. 1.0 is normal speed.
   --
   -- Return true on success, false on failure. Will fail if the sample instance is attached directly to a voice.
   function al_set_audio_stream_speed (stream : System.Address; val : float) return Extensions.bool;
   pragma Import (C, al_set_audio_stream_speed, "al_set_audio_stream_speed");

   -- Set the playback gain.
   --
   -- Returns true on success, false on failure. Will fail if the sample instance is attached directly to a voice.
   function al_set_audio_stream_gain (stream : System.Address; val : float) return Extensions.bool;
   ...
   --
   -- Returns true on success, false on failure. Will fail if the sample instance is attached directly to a voice.
   function al_set_audio_stream_pan (stream : System.Address; val : float) return Extensions.bool;
   pragma Import (C, al_set_audio_stream_pan, "al_set_audio_stream_pan");

   -- Set the playback mode.
   --
   -- Returns true on success, false on failure.
   function al_set_audio_stream_playmode (stream : System.Address; val : ALLEGRO_PLAYMODE) return Extensions.bool;
   pragma Import (C, al_set_audio_stream_playmode, "al_set_audio_stream_playmode");

   -- Change whether the stream is playing.
   --
   -- Returns true on success, false on failure.
   function al_set_audio_stream_playing (stream : System.Address; val : Extensions.bool) return Extensions.bool;
   pragma Import (C, al_set_audio_stream_playing, "al_set_audio_stream_playing");

   -- Detach the stream from whatever it's attached to, if anything.
   function al_detach_audio_stream (stream : System.Address) return Extensions.bool;
   ...
   function al_set_audio_stream_fragment (stream : System.Address; val : System.Address) return Extensions.bool;
   pragma Import (C, al_set_audio_stream_fragment, "al_set_audio_stream_fragment");
   ...
   function al_rewind_audio_stream (stream : System.Address) return Extensions.bool;
   ...
   function al_seek_audio_stream_secs (stream : System.Address; time : double) return Extensions.bool;
   ...
   function al_get_audio_stream_position_secs (stream : System.Address) return double;
   ...
   function al_get_audio_stream_length_secs (stream : System.Address) return double;
   ...
   function al_set_audio_stream_loop_secs
     (stream : System.Address;
      start : double;
      c_end : double) return Extensions.bool;
   pragma Import (C, al_set_audio_stream_loop_secs, "al_set_audio_stream_loop_secs");
   ...
   function al_get_audio_stream_event_source (stream : System.Address) return access Events.ALLEGRO_EVENT_SOURCE;
   ...
   procedure al_destroy_mixer (mixer : System.Address);
   ...
   --
   -- Returns true on success, false on failure.
   function al_attach_sample_instance_to_mixer (stream : System.Address; mixer : System.Address) return Extensions.bool;
   pragma Import (C, al_attach_sample_instance_to_mixer, "al_attach_sample_instance_to_mixer");

   -- Attach a stream to a mixer.
   --
   -- Returns true on success, false on failure.
   function al_attach_audio_stream_to_mixer (stream : System.Address; mixer : System.Address) return Extensions.bool;
   pragma Import (C, al_attach_audio_stream_to_mixer, "al_attach_audio_stream_to_mixer");
   ...
   function al_attach_mixer_to_mixer (stream : System.Address; mixer : System.Address) return Extensions.bool;
   ...
   --
   -- Returns true on success, false on failure.
   function al_set_mixer_frequency (mixer : System.Address; val : unsigned) return Extensions.bool;
   ...
   --
   -- Returns true on success, false on failure.
   function al_set_mixer_quality (mixer : System.Address; val : ALLEGRO_MIXER_QUALITY) return Extensions.bool;
   pragma Import (C, al_set_mixer_quality, "al_set_mixer_quality");

   -- Set the mixer gain (amplification factor).
   --
   -- Returns true on success, false on failure.
   function al_set_mixer_gain (mixer : System.Address; gain : float) return Extensions.bool;
   pragma Import (C, al_set_mixer_gain, "al_set_mixer_gain");

   -- Change whether the mixer is playing.
   --
   -- Returns true on success, false on failure.
   function al_set_mixer_playing (mixer : System.Address; val : Extensions.bool) return Extensions.bool;
   pragma Import (C, al_set_mixer_playing, "al_set_mixer_playing");

   -- Detach the mixer from whatever it is attached to, if anything.
   function al_detach_mixer (mixer : System.Address) return Extensions.bool;
   ...
   procedure al_destroy_voice (voice : System.Address);
   ...
   --
   -- Returns true on success, false on failure.
   function al_attach_sample_instance_to_voice (stream : System.Address; voice : System.Address) return Extensions.bool;
   pragma Import (C, al_attach_sample_instance_to_voice, "al_attach_sample_instance_to_voice");
   ...
   --
   -- Returns true on success, false on failure.
   function al_attach_audio_stream_to_voice (stream : System.Address; voice : System.Address) return Extensions.bool;
   pragma Import (C, al_attach_audio_stream_to_voice, "al_attach_audio_stream_to_voice");
   ...
   --
   -- Returns true on success, false on failure.
   function al_attach_mixer_to_voice (mixer : System.Address; voice : System.Address) return Extensions.bool;
   pragma Import (C, al_attach_mixer_to_voice, "al_attach_mixer_to_voice");

   -- Detaches the mixer or sample or stream from the voice.
   procedure al_detach_voice (voice : System.Address);
   pragma Import (C, al_detach_voice, "al_detach_voice");

   -- Return the frequency of the voice, e.g. 44100.
   function al_get_voice_frequency (voice : System.Address) return unsigned;
   ...
   --
   -- Returns true on success, false on failure.
   function al_set_voice_position (voice : System.Address; val : unsigned) return Extensions.bool;
   ...
   --
   -- Returns true on success, false on failure.
   function al_set_voice_playing (voice : System.Address; val : Extensions.bool) return Extensions.bool;
   ...
   function al_get_channel_count (conf : ALLEGRO_CHANNEL_CONF) return stdint.size_t;
   ...
   function al_get_audio_depth_size (conf : ALLEGRO_AUDIO_DEPTH) return stdint.size_t;
   pragma Import (C, al_get_audio_depth_size, "al_get_audio_depth_size");

   -- Reserves a number of sample instances, attaching them to the default mixer. If no default mixer is set when this function is called, then it will automatically create a voice with an attached mixer, which becomes the default mixer.
   --
   -- Returns true on success, false on error. al_install_audio must have been called first.
   function al_reserve_samples (reserve_samples : int) return Extensions.bool;
   ...
   function al_get_default_mixer return System.Address;
   ...
   --
   -- Returns true on success, false on error.
   function al_set_default_mixer (mixer : System.Address) return Extensions.bool;
   ...
   function al_play_sample
     (data : System.Address;
      ...
      ret_id : access ALLEGRO_SAMPLE_ID) return Extensions.bool;
   ...
   function al_register_sample_loader (ext : Interfaces.C.Strings.chars_ptr; loader : access function (arg1 : Interfaces.C.Strings.chars_ptr) return System.Address) return Extensions.bool;
   ...
   --
   -- Returns true on success, false on error. Returns false if unregistering an entry that doesn't exist.
   function al_register_sample_saver (ext : Interfaces.C.Strings.chars_ptr; saver : access function (arg1 : Interfaces.C.Strings.chars_ptr; arg2 : System.Address) return Extensions.bool) return Extensions.bool;
   ...
   function al_register_audio_stream_loader (ext : Interfaces.C.Strings.chars_ptr; stream_loader : access function
        (arg1 : Interfaces.C.Strings.chars_ptr;
         arg2 : stdint.size_t;
         arg3 : unsigned) return System.Address) return Extensions.bool;
   pragma Import (C, al_register_audio_stream_loader, "al_register_audio_stream_loader");
   ...
   --
   -- Returns true on success, false on error. Returns false if unregistering an entry that doesn't exist.
   function al_register_sample_loader_f (ext : Interfaces.C.Strings.chars_ptr; loader : access function (arg1 : System.Address) return System.Address) return Extensions.bool;
   pragma Import (C, al_register_sample_loader_f, "al_register_sample_loader_f");
   ...
   --
   -- Returns true on success, false on error. Returns false if unregistering an entry that doesn't exist.
   function al_register_sample_saver_f (ext : Interfaces.C.Strings.chars_ptr; saver : access function (arg1 : System.Address; arg2 : System.Address) return Extensions.bool) return Extensions.bool;
   pragma Import (C, al_register_sample_saver_f, "al_register_sample_saver_f");
   ...
   function al_register_audio_stream_loader_f (ext : Interfaces.C.Strings.chars_ptr; stream_loader : access function
        (arg1 : System.Address;
         arg2 : stdint.size_t;
         arg3 : unsigned) return System.Address) return Extensions.bool;
   pragma Import (C, al_register_audio_stream_loader_f, "al_register_audio_stream_loader_f");
   ...
   function al_load_sample (filename : Interfaces.C.Strings.chars_ptr) return System.Address;
   ...
   --
   -- Returns true on success, false on error.
   function al_save_sample (filename : Interfaces.C.Strings.chars_ptr; spl : System.Address) return Extensions.bool;
   ...
   function al_load_audio_stream
     (filename : Interfaces.C.Strings.chars_ptr;
      buffer_count : stdint.size_t;
      samples : unsigned) return System.Address;
   ...
   function al_load_sample_f (fp : System.Address; ident : Interfaces.C.Strings.chars_ptr) return System.Address;
   ...
   function al_save_sample_f
     (fp : System.Address;
      ...
      spl : System.Address) return Extensions.bool;
